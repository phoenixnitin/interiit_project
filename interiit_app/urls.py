...
router.register(r'sport/download/athletics/men', views.json_athletics_men, 'json_athletics_men')
router.register(r'sport/download/athletics/women', views.json_athletics_women, 'json_athletics_women')
router.register(r'sport/download/staff', views.json_staff, 'json_staff')
router.register(r'sport/download/other_games/men', views.json_sport_all_other_games_men, 'json_sport_all_other_games_men')
router.register(r'sport/download/other_games/women', views.json_sport_all_other_games_women, 'json_sport_all_other_games_women')
